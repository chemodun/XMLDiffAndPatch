...
* optimize child comparison logic using LCS-based approach and streamline edit block processing ([e99c3c6](https://github.com/chemodun/XMLDiffAndPatch/commit/e99c3c6a1e85aa826401d936827123c1692a97a5))
* update command documentation and simplify URI handling in explorer commands ([b6b41d1](https://github.com/chemodun/XMLDiffAndPatch/commit/b6b41d1d8700b56fe37fafd28144a8784059b9d3))
* update configuration structure and rename mainFolderRole to improve clarity ([8a76b2c](https://github.com/chemodun/XMLDiffAndPatch/commit/8a76b2cea3f7ee8b33ce84c3512b9b940204be20))


### Miscellaneous Chores

* initial commit ([d6220dd](https://github.com/chemodun/XMLDiffAndPatch/commit/d6220ddfb965656cc98692c8f403ed01aa3e8315))
* **main:** release xmldiffandpatch 0.6.0 ([c0094fb](https://github.com/chemodun/XMLDiffAndPatch/commit/c0094fb207242b132509c3411b406ca3d492678b))
* recreate XMLDiffAndPatch workspace configuration file ([ccee3aa](https://github.com/chemodun/XMLDiffAndPatch/commit/ccee3aa86895159656505aa3fd87d2025fe9e31f))
* release 0.6.1 ([52db787](https://github.com/chemodun/XMLDiffAndPatch/commit/52db7870ef34e71635b9e6383c1c0e0f4ca154ef))
* remove file ([f76d658](https://github.com/chemodun/XMLDiffAndPatch/commit/f76d658d8ee15134f3ebcde19df62ed66ff7c8e2))


### Documentation

* **bbcode:** Update bbcode files ([a5aa8a0](https://github.com/chemodun/XMLDiffAndPatch/commit/a5aa8a01ecbb833753eabdd68f6728bbfd413a36))
* **bbcode:** Update bbcode files ([7a78ccc](https://github.com/chemodun/XMLDiffAndPatch/commit/7a78ccc22e18a86c6d8bed7c60950ee92084447d))
* **bbcode:** Update bbcode files ([d1764ee](https://github.com/chemodun/XMLDiffAndPatch/commit/d1764ee8b34a90d8b2d3dc8d6841bb8b2ce7e970))
* enhance README with detailed folder pairs explanation and troubleshooting tips ([485a8f6](https://github.com/chemodun/XMLDiffAndPatch/commit/485a8f6d5b44278d5a9c434af456e74987b45242))
* update demo section in README with new GIF and YouTube link ([735e441](https://github.com/chemodun/XMLDiffAndPatch/commit/735e441e589c33722174b96092d24f8e5f1b6cf5))
* update image links in README to use raw GitHub URLs ([839dc8f](https://github.com/chemodun/XMLDiffAndPatch/commit/839dc8f3cd71ec13f67f91f3dc48f430b062a913))
* update README for consistency in formatting and clarity ([361818a](https://github.com/chemodun/XMLDiffAndPatch/commit/361818a42977bc9f8c0869414a0f8473d4ad6c53))
